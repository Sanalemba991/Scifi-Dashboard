...
const recentActivity = [
  {
    time: "14:32:07",
    event: "Personnel file accessed - EMP-2026-0847",
    type: "info",
  },
  {
    time: "14:28:15",
    event: "Security scan completed - All clear",
    type: "success",
  },
  {
    time: "14:15:33",
    event: "Operation NIGHTFALL status update received",
    type: "warning",
  },
  {
    time: "13:58:42",
    event: "New communication from Command HQ",
    type: "info",
  },
  {
    time: "13:45:00",
  ...
  {
    time: "13:30:22",
    event: "Anomaly detected in Sector 7 - Resolved",
    type: "warning",
  },
];
...
const alerts = [
  {
    severity: "HIGH",
    message: "Operation PHOENIX requires immediate attention",
    time: "10 MIN AGO",
  },
  {
    severity: "MEDIUM",
    message: "Database synchronization at 87%",
    time: "25 MIN AGO",
  },
  {
    severity: "LOW",
    ...
    <div className="space-y-6">
      ...
      <div className="glass glow-border rounded-lg p-6 fade-in-up corner-accent holographic">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-gray-500 text-sm tracking-widest mb-1">
              WELCOME BACK
            </p>
            <h1 className="text-2xl font-bold text-white tracking-wider hover-glow">
              {employeeData.name}
            </h1>
            <p className="text-cyan-400 text-sm mt-1 neon-text-cyan">
              {employeeData.designation}
            </p>
          </div>
          <div className="text-right">
            <p className="text-gray-500 text-xs">CURRENT SESSION</p>
            <p className="text-xl font-mono text-cyan-400 neon-text-cyan">
              {formatSessionTime(sessionTime)}
            </p>
            <p className="text-gray-600 text-xs mt-1">
              CLEARANCE: {employeeData.clearanceLevel}
            </p>
          </div>
        </div>
      </div>
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-white mt-1">
                  {index === 0
                    ...
                    ? animatedStats[1]
                    : index === 2
                    ? `${((animatedStats[2] / 100) * 100).toFixed(2)}%`
                    : stat.value}
                </p>
                <p className="text-green-400 text-xs mt-1">{stat.change}</p>
              </div>
              <div className="w-10 h-10 glass rounded-lg flex items-center justify-center text-cyan-400 text-xl float">
                {stat.icon}
              </div>
            </div>
          </div>
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-8">
          <div
            className="glass glow-border rounded-lg overflow-hidden fade-in-left"
            style={{ animationDelay: "0.2s" }}
          >
            <div className="bg-gradient-to-r from-cyan-900/50 to-transparent px-4 py-3 border-b border-cyan-500/30">
              <div className="flex items-center justify-between">
                <span className="text-xs text-cyan-400 tracking-widest">
                  ◈ ACTIVE OPERATIONS OVERVIEW
                </span>
                <span className="text-xs text-gray-500">
                  {employeeData.projects.length} ASSIGNMENTS
                </span>
              </div>
            </div>
            <div className="p-4">
              <div className="grid grid-cols-2 gap-4">
                {employeeData.projects.slice(0, 4).map((project, index) => (
                  <div
                    key={project.id}
                    className={`glass p-4 rounded-lg border border-transparent hover:border-cyan-500/30 transition-all hover-lift card-shine fade-in-up`}
                  ...
                  >
                    ...
                    <h4 className="text-white font-bold text-sm tracking-wider mb-3 hover-glow">
                      {project.name}
                    </h4>
        ...
        <div className="col-span-4">
          <div
            className="glass glow-border rounded-lg overflow-hidden h-full fade-in-right"
            style={{ animationDelay: "0.2s" }}
          >
            <div className="bg-gradient-to-r from-cyan-900/50 to-transparent px-4 py-3 border-b border-cyan-500/30">
              <div className="flex items-center justify-between">
        ...
        <div className="col-span-6">
          <div
            className="glass glow-border rounded-lg overflow-hidden fade-in-up"
            ...
            <div className="p-4">
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    key={metric.name}
                    className={`glass p-3 rounded hover-lift fade-in-up`}
              ...
              <div
                className="mt-4 p-3 glass rounded fade-in-up"
              ...
              >
                ...
                <div className="flex items-end gap-0.5 h-12">
                  {[
                    45, 62, 38, 75, 52, 68, 42, 85, 55, 72, 48, 78, 58, 65, 40,
                    88, 50, 70, 45, 82, 55, 68, 42, 75, 60, 72, 48, 85, 52, 78,
                  ].map((height, i) => (
                    <div
                      key={i}
            ...
            {[
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-12 h-12 glass rounded-lg flex items-center justify-center text-cyan-400 text-xl float pulse-ring">
                    {person.avatar}
                  </div>
                  <div className="flex-1 min-w-0">
                    ...
                    <h6 className="text-sm text-white font-bold tracking-wider truncate hover-glow">
                      {person.name}
                    </h6>
